...
public class Main {
    ...
    private static void gradeStudent(StudentService studentService, Scanner scanner) {
        ...
        HashMap<String, EnrolledCourse> enrolledCourse = studentService.enrolledCourses(student);
        System.out.println(enrolledCourse);


        System.out.println("Insert course ID to be graded");
        String courseId = scanner.next();
        studentService.enrolledCourses(student);
        if (enrolledCourse == null) {
            System.out.println("Invalid Course ID");
            return;
        }

        System.out.println("Insert course grade for " + enrolledCourse.get(courseId));
        double grade = scanner.nextDouble();
        enrolledCourse.get(courseId).setGrade(grade);
//       studentService.gradeStudent(student, courseId, grade);
    ...
    private static void showPassedCourses(StudentService studentService, Scanner scanner) {
        ...
        Student student = getStudentInformation(studentService, scanner);
        studentService.getPassedCourses(student);
    }
}// End of Main Class
